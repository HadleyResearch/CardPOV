...
Document templates included are:
	...
	All documentation is provided in LaTeX format. For a good tutorial on LaTeX,
see http://en.wikibooks.org/wiki/LaTeX/Absolute_Beginners.
	The templates provided herein should be easily compiled using any standard
LaTeX distribution, with the exception that they use the (not included) TikZ 
package for header graphics. Therefore, before running any of these templates,
you must download and install the pgf package to your TeX distribution.
